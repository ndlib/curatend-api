...
module SwaggerClient
  ...
  class ObjectsQueryResult
    attr_accessor :context

    # The query string that was provided
    attr_accessor :query

    attr_accessor :total_items

    attr_accessor :starting_offset
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'startingOffset')
        self.starting_offset = attributes[:'startingOffset']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          starting_offset == o.starting_offset &&
          results == o.results &&
    ...
    def hash
      [context, query, total_items, starting_offset, results, pagination].hash
    end
